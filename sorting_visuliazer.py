...
options_frame = Frame(root, width= 1000, height=300, bg='violet')
...
Button(options_frame, text="Start Sorting", command=sorting, bg='light blue',height=5).grid(row=0, column=3, padx=5, pady=5)
...
Button(options_frame, text="Current Array", command=Generate_array, bg='light blue',height=5).grid(row=1, column=3, padx=10, pady=10)
